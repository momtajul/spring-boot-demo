...
import com.momtajul.spring.data.book.BookRepository;
import com.momtajul.spring.data.customer.Customer;
import com.momtajul.spring.data.customer.CustomerRepository;
import com.momtajul.spring.data.user.User;
import com.momtajul.spring.data.user.UserRepository;
...
public class DataLoader implements CommandLineRunner {
    ...
    @Inject
    public DataLoader(BookRepository bookRepository, CustomerRepository customerRepository, UserRepository userRepository) {
    ...
    private void loadUsers(){
        User u1 = new User("momtajul", "momtajul");
        User u2 = new User("karim", "karim");
